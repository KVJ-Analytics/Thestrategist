                        ...
                        while ($file = readdir($handle)) {
							...
							{  
								...
								?>
								 ...
								 <li>
								<a  href="javascript:displayMenu('divcenter','<?php echo $file; ?>','<?php echo $file; ?>/index.php&dropmenu=<?php echo $dropmenu;?>');"><?php include("$f_path") ?></a> 
								...
								?> <li><a href="javascript:displayMenu('divcenter','<?php echo $filedr; ?>','<?php echo $filedr; ?>/index.php&dropmenu=<?php echo $dropmenu;?>');"><?php include("$f_pathd") ?></a>
								<?php
								...
								?> <li><a href="javascript:displayMenu('divcenter','<?php echo $filedr; ?>','<?php echo $filedr; ?>/index.php&dropmenu=<?php echo $dropmenu;?>');"><?php include("$f_pathd") ?></a></li>
								  <?php
								  }
								  }
								  }
								...
								if($filedrop=="menu_order/Mainsite")
								{
								
								$handleinner=opendir("menu_order/Mainsite/MainsiteItems");
								 while ($filed = readdir($handleinner)) {
								 $filedr="Mainsite/MainsiteItems/".$filed;
									if (!in_array($filed,$list_ignore)) {  
									if(is_dir("menu_order/Mainsite/MainsiteItems/".$filed))
									{  
									$f_pathd="menu_order/Mainsite/MainsiteItems/".$filed."/caption/menu_caption.php";
								?> <li><a href="javascript:displayMenu('divcenter','<?php echo $filedr; ?>','<?php echo $filedr; ?>/index.php&dropmenu=<?php echo $dropmenu;?>');"><?php include("$f_pathd") ?></a>
                                
                                
                                 <?php
                                if($filedr=="Mainsite/MainsiteItems/GalleryItems")
								{
								?>
                                <ul>
                                <?php
								$handleinnerg=opendir("menu_order/Mainsite/MainsiteItems/GalleryItems");
								 while ($filedg = readdir($handleinnerg)) {
								 
								 $filedrg="Mainsite/MainsiteItems/GalleryItems/".$filedg;
								
								 if (!in_array($filedg,$list_ignore)) {  
								
									if(is_dir("menu_order/Mainsite/MainsiteItems/GalleryItems/".$filedg) && $filedg!="caption" )
									{ 
									$f_pathdg="menu_order/Mainsite/MainsiteItems/GalleryItems/".$filedg."/caption/menu_caption.php";
								...
								?>
                                 <?php
                                if($filedr=="Mainsite/MainsiteItems/DynamicContents_Category")
								{
								?>
                                <ul>
                                <?php
								$handleinnerg=opendir("menu_order/Mainsite/MainsiteItems/DynamicContents_Category");
								 while ($filedg = readdir($handleinnerg)) {
								 
								 $filedrg="Mainsite/MainsiteItems/DynamicContents_Category/".$filedg;
								
								 if (!in_array($filedg,$list_ignore)) {  
								
									if(is_dir("menu_order/Mainsite/MainsiteItems/DynamicContents_Category/".$filedg) && $filedg!="caption" )
									{ 
									$f_pathdg="menu_order/Mainsite/MainsiteItems/DynamicContents_Category/".$filedg."/caption/menu_caption.php";
								...
								?>
                                <?php
                                if($filedr=="Mainsite/MainsiteItems/Missions")
								{
								?>
                                <ul>
                                <?php
								$handleinnerg=opendir("menu_order/Mainsite/MainsiteItems/Missions");
								 while ($filedg = readdir($handleinnerg)) {
								 
								 $filedrg="Mainsite/MainsiteItems/Missions/".$filedg;
								
								 if (!in_array($filedg,$list_ignore)) {  
								
									if(is_dir("menu_order/Mainsite/MainsiteItems/Missions/".$filedg) && $filedg!="caption" )
									{ 
									$f_pathdg="menu_order/Mainsite/MainsiteItems/Missions/".$filedg."/caption/menu_caption.php";
								...
								?>
                                <?php
                                if($filedr=="Mainsite/MainsiteItems/Directory")
								{
								?>
                                <ul>
                                <?php
								$handleinnerg=opendir("menu_order/Mainsite/MainsiteItems/Directory");
								 while ($filedg = readdir($handleinnerg)) {
								 
								 $filedrg="Mainsite/MainsiteItems/Directory/".$filedg;
								
								 if (!in_array($filedg,$list_ignore)) {  
								
									if(is_dir("menu_order/Mainsite/MainsiteItems/Directory/".$filedg) && $filedg!="caption" )
									{ 
									$f_pathdg="menu_order/Mainsite/MainsiteItems/Directory/".$filedg."/caption/menu_caption.php";
								...
								?>
								 <?php
                                if($filedr=="Mainsite/MainsiteItems/InstitutionItems")
								{
								?>
                                <ul>
                                <?php
								$handleinnerg=opendir("menu_order/Mainsite/MainsiteItems/InstitutionItems");
								 while ($filedg = readdir($handleinnerg)) {
								 
								 $filedrg="Mainsite/MainsiteItems/InstitutionItems/".$filedg;
								
								 if (!in_array($filedg,$list_ignore)) {  
								
									if(is_dir("menu_order/Mainsite/MainsiteItems/InstitutionItems/".$filedg) && $filedg!="caption" )
									{ 
									$f_pathdg="menu_order/Mainsite/MainsiteItems/InstitutionItems/".$filedg."/caption/menu_caption.php";
