...
<br/><br/><?php */?>
  ...
  <div class="card-body px-lg-5 pt-0"  style="padding-bottom:10px;">
    ...
    <!-- Form -->
    <form class="text-center" form name="frm1"style="color: #757575;"action="logincode.php" method="post" enctype="multipart/form-data">

      <!-- Email -->
   
    <div class="form-group">
      <label class="control-label col-sm-3" style="padding:14px;" for="Username">User Email:</label>
      <div class="col-sm-9" style="padding:14px;">
        <input type="email" class="form-control" id="Username" placeholder="Registered Mail" name="Username">
      </div>
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10"style="padding:19px">
        <button type="submit" class="btn btn-default" onclick="javascript:validatefrm();">Login </button><span> New User ?<a href="index.php">Register</a></span>
      </div>
    </div>
