...
*/
$db2	= 	new Database();
								$stmt=$db2->query('select * from colleges');	
  ...
  <div class="card-body px-lg-5 pt-0"  style="padding-bottom:10px;">
   ...
   <?php /*?>
    <div class="form-group">
      ...
      <div class="col-sm-9"style="padding:14px;">
        <input type="text" class="form-control" id="txt" placeholder=" Middle name" name="mname">
      </div>
      ...
      <div class="col-sm-9"style="padding:14px;">
        <input type="text" class="form-control" id="lmail" placeholder="Last Name" name="lname">
      </div>
      ...
      <div class="col-sm-9"style="padding:14px;">
        <input type="text" class="form-control" id="full" placeholder=" Full Name" name="fname">
      </div>
	...
	?>
     ...
     <div class="form-group">
      ...
      <div class="col-sm-9"style="padding:14px;">
        <input type="password" class="form-control" id="password" placeholder=" Password" name="pssword">
      </div>
