...
//http://thestrategist.co.in/UserController/activation_mail?use=radhikatreegear2019@gmail.com&name=radhika&password=rad
header('Location:'."http://thestrategist.co.in/UserController/activation_mail?use=".$email."&name=".$fname."&password=".$pssword);
}
?>