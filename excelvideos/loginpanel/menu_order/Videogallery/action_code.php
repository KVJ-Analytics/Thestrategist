...
$session_admintoken=$_SESSION['admintoken'];
 ...
 $video=$_FILES['video']['name'];
	if($_FILES['video']['error']==0)
	{
		...
		$db9 	= 	new Database();
    $db9->insertdata('video_gallery',array("category_id"=>$category_id,"caption"=>$caption,"video"=>$video,"exam" => $exam));
	}
	...
	$db1 	= 	new Database();
$db1->updatedata('video_gallery',array("category_id"=>$category_id,"caption"=>$caption,"exam" => $exam),array("video_id"=>$video_id));
		$db1->dbclose();
	}
	//---------------------------------Delete------------------------------------------------------------------------------
