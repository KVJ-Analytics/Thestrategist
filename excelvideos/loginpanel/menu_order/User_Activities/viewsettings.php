...
<?php include("topmenu3.php"); ?>
	...
	$i=0;
	$db1 	= 	new Database();
	$stmt=$db1->query('select * from registration where acount_status="1" and category_id='.$vvid.' and college='.$vid.' group by email order by regid desc');	
	$rows = $db1->resultset();
//	print_r($rows);
		$db1->dbclose();
    ...
    <tr>
        ...
        <td class="center"><?php echo $result0['full_name']; ?></td>
        <td class="center">
