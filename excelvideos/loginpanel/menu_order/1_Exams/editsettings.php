...
?>    
            <div class="box-content">
			 ...
			 $category_id=base64_decode($_GET['category_id']);
			  $db1 	= 	new Database();
			$db1->query('select* from exams where exam=:category_id');
	...
	<input type="hidden" name="exam_id" id="category_id" value="<?php echo $category_id; ?>" />
                   <div class="form-group">
                        ...
                        <input type="text" id="txtCategory" name="txtexam" required="required" class="form-control" value="<?php echo $category; ?>">
                    </div>
