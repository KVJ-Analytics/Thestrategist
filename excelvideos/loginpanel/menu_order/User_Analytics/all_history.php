...
<?php $res_user='';?>
	...
	$i=0;
	$db1 	= 	new Database();
	$stmt=$db1->query('select * from registration where acount_status="1" ');	
	$rows = $db1->resultset();
		$db1->dbclose();
...
//print_r($res_user);
	?>
      ...
      <form method="post" action="http://thestrategist.co.in/excelvideos/loginpanel/menu_order/User_Analytics/xlout.php">
