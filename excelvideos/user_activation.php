...
<html>
  ...
  <p class="lead">
    <a class="btn btn-primary btn-sm" href="http://thestrategist.co.in/excelvideos/login.php" role="button">Continue to Login</a>
  </p>
</div>
</body>
</html>
<?php
  ...
  <p class="lead">
    <a class="btn btn-primary btn-sm" href="http://thestrategist.co.in/excelvideos" role="button">Go to Registration</a>
  </p>
</div>
</body>
</html>
