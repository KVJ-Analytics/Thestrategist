							...
							?>
								...
								<div class="col-md-4 col-12">
									<div class="single-blog">
										<div class="image-boxd">
											<!--<img src="images/blog/3.jpg" alt="">-->
											
											<div style="width:100%;height:260px;" class="">
											    <?php
											 
											        echo '<iframe width="100%" height="260px" src="https://www.youtube.com/embed/'.$vd->video.'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
										...
										<div class="post-meta">
											<h5 class="title"><a href="blog-details.html"><?php echo $vd->title; ?></a></h5>
											<p><?php echo $vd->description; ?></p>
