	...
	<div class="wrapper">
  		...
  		<div class="content-wrapper">
  			<section class="col-lg-12">
               ...
               <form class="cmxform form-horizontal adminex-form" id="commentForm" method="post" action="<?php echo base_url(); ?>index.php/AdminController/add_training_features_process" name="myform" enctype="multipart/form-data">
