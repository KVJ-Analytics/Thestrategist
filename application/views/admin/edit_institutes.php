  		...
  		<div class="content-wrapper">
  			<section class="col-lg-12">
    			<div class="content-area">
                	<div class="col-md-12">
                    	<h2><i class="fa fa-file-text-o"></i> Edit institutes</h2>
                    </div>                   
                ...
                <div class="content-area">
                    ...
                    ?>
               <form class="cmxform form-horizontal adminex-form" id="commentForm" method="post" action="<?php echo base_url(); ?>index.php/AdminController/update_institutes" name="myform" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-12">
                        	...
                        	<div class="form-wrap">
                                ...
                                <table>
										...
										<tr>
                                        	<td width="15%">Image (272px X 90px)</td>
                                            <td width="5%">:</td>
                                            <td width="80%">
                                                <input type="file" id="input-file-now-custom-2" data-default-file="<?php echo base_url();?>assets/images/uploads/institutes/<?php echo $p_image; ?>" class="dropify" data-height="150" name="userfileImage" /> 
