                    	...
                    	<div class="form-wrap">
                           <div class="form-wrap-title list-form-wrap-title">
                                ...
                                <ul class="list-actions">
                                	<li class="created"><a href="<?php echo base_url(); ?>index.php/AdminController/slider_add"><i class="fa fa-plus"></i>Add New</a></li>
                            ...
                            <form name="myform" id="myform" action="<?php echo base_url();?>index.php/AdminController/deleteMultipleslider/" method="post">
                                ...
                                <table id="example" class="table table-striped table-bordered example" width=100%>
                                    ...
                                    <tbody>
                                    	...
                                    	<tr>
                                            ...
                                            <td><img style="width:100px;" src="<?php echo base_url();?>assets/images/uploads/sliders/<?php echo $row->image;  ?>"/></td>
                                           
                                           
                                            <td><?php echo $row->sort_order; ?></td>
                                            <td>
                                           
                                            	<a href="<?php echo base_url(); ?>index.php/AdminController/slider_edit/<?php echo $row->id;?>"><button type="button" class="btn btn-success">Edit</button></a>
                                            	<a href="<?php echo base_url(); ?>index.php/AdminController/slider_delete/<?php echo $row->id;?>"><button type="button" class="btn btn-danger">Delete</button></a>
                                          	</td>
                                        </tr> 
                                        <?php } 
                                    }
