  		...
  		<div class="content-wrapper">
  			<section class="col-lg-12">
    			<div class="content-area">
                	<div class="col-md-12">
                    	<h2><i class="fa fa-file-text-o"></i> Edit training method</h2>
                    </div>                   
                ...
                <div class="content-area">
                    ...
                    ?>
               <form class="cmxform form-horizontal adminex-form" id="commentForm" method="post" action="<?php echo base_url(); ?>index.php/AdminController/update_training_method" name="myform" enctype="multipart/form-data">
                        	...
                        	<div class="form-wrap">
                                ...
                                <table>
                                        ...
                                        <tr>
											...
											<textarea name="p_head2"><?php echo $ph2; ?></textarea></td>
                                        </tr>
                                    	...
                                    	<tr>
                                            ...
                                            <td width="5%">:</td>
                                            <td width="80%">
                                                <input type="file" id="input-file-now-custom-2" data-default-file="<?php echo base_url();?>assets/images/uploads/training_methods/<?php echo $p_image; ?>" class="dropify" data-height="150" name="userfileImage" /> 
