  		...
  		<div class="content-wrapper">
  			<section class="col-lg-12">
    			<div class="content-area">
                	...
                	<div class="col-md-12">
                    	<h2><i class="fa fa-file-text-o"></i>Excel Functions</h2>
                    </div>
                	...
                	<div class="col-md-12">
                    	...
                    	<div class="form-wrap">
                           <div class="form-wrap-title list-form-wrap-title">
                                <h3 class="inline-block">Excel Functions</h3>

                                <ul class="list-actions">
                                	<li class="created"><a href="<?php echo base_url(); ?>index.php/AdminController/excel_functions_add"><i class="fa fa-plus"></i>Add New</a></li>
                            ...
                            <form name="myform" id="myform" action="<?php echo base_url();?>index.php/AdminController/deleteMultipleexcel_functions/" method="post">
                                    ...
                                    <tbody>
                                    	...
                                    	<tr>
                                            ...
                                            <td>
                                            	...
                                            	<a href="<?php echo base_url(); ?>index.php/AdminController/excel_functions_edit/<?php echo $row->id;?>"><button type="button" class="btn btn-success">Edit</button></a>
                                            	<a href="<?php echo base_url(); ?>index.php/AdminController/excel_functions_delete/<?php echo $row->id;?>"><button type="button" class="btn btn-danger">Delete</button></a>
                                          	</td>
                                        </tr> 
                                        <?php } 
                                    }
