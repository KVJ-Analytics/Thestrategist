  		...
  		<div class="content-wrapper">
  			<section class="col-lg-12">
    			<div class="content-area">
                	...
                	<div class="col-md-12">
                    	<h2><i class="fa fa-file-text-o"></i>Tutorial Categories</h2>
                    </div>
                	...
                	<div class="col-md-12">
                    	...
                    	<div class="form-wrap">
                           <div class="form-wrap-title list-form-wrap-title">
                                <h3 class="inline-block">Tutorial Categories</h3>
							...
							<div class="form-wrap-body form-tbl">
								<form name="myform2" id="myform2" method="post" action="<?php echo base_url();?>index.php/AdminController/add_tcategory_process" enctype="multipart/form-data">
								<h3>Add Category</h3>
								
								<table style="border:none;">
                                    	<tr>
                                        	<td width="15%">Tutorial Category</td>
                                            <td width="5%">:</td>
                                            <td width="80%">
                            ...
                            <form name="myform" id="myform" action="<?php echo base_url();?>index.php/AdminController/deleteMultipletcategory/" method="post">
                                    	...
                                    	<tr>
                                           ...
                                           <td><?php echo $row->sort_order;?></td>
                                            <td>
                                            	...
                                            	<a href="<?php echo base_url(); ?>index.php/AdminController/tcategory_delete/<?php echo $row->id;?>"><button type="button" class="btn btn-danger">Delete</button></a>
                                          	</td>
                                        </tr> 
                                        <?php } 
                                    }
