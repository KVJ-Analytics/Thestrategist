  		...
  		<div class="content-wrapper">
  			<section class="col-lg-12">
    			<div class="content-area">
                	...
                	<div class="col-md-12">
                    	<h2><i class="fa fa-file-text-o"></i>Images</h2>
                    </div>
                	...
                	<div class="col-md-12">
                    	...
                    	<div class="form-wrap">
                           <div class="form-wrap-title list-form-wrap-title">
                                <h3 class="inline-block">Image</h3>
							...
							<div class="form-wrap-body form-tbl">
								<form name="myform2" id="myform2" method="post" action="<?php echo base_url();?>index.php/AdminController/add_gallery_process" enctype="multipart/form-data">
								<h3>Add Category</h3>
								
								<table style="border:none;">
                                    	<tr>
                                        	<td width="15%">Image (370 X 260 px)Max size 1MB</td>
                                            <td width="5%">:</td>
                                            <td width="80%">
                                                <input type="file" id="input-file-now-custom-2" data-default-file="" class="dropify" data-height="150" name="userfileImage" />
                                             </td>
                                        </tr>
										<tr>
                            ...
                            <form name="myform" id="myform" action="<?php echo base_url();?>index.php/AdminController/deleteMultiplegallery/" method="post">
                                ...
                                <table id="example" class="table table-striped table-bordered example" width=100%>
                                    ...
                                    <tbody>
                                    	...
                                    	<tr>
                                            ...
                                            <td><img style="width:82px;height:82px;" src="<?php echo base_url(); ?>assets/images/uploads/gallery/<?php echo $row->image;?>"></td>
                                           <td><?php echo $row->sort_order;?></td>
                                            <td>
                                           
                                            	
                                            	<a href="<?php echo base_url(); ?>index.php/AdminController/gallery_delete/<?php echo $row->id;?>"><button type="button" class="btn btn-danger">Delete</button></a>
                                          	</td>
                                        </tr> 
                                        <?php } 
                                    }
