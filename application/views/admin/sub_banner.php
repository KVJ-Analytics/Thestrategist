  		...
  		<div class="content-wrapper">
  			<section class="col-lg-12">
    			<div class="content-area">
                	...
                	<div class="col-md-12">
                    	<h2><i class="fa fa-file-text-o"></i> Page Banners Listings</h2>
                    </div>
                	...
                	<div class="col-md-12">
                    	...
                    	<div class="form-wrap">
                           <div class="form-wrap-title list-form-wrap-title">
                                <h3 class="inline-block">Page Banners</h3>
                               <!-- <ul class="list-actions">
                                	<li class="created"><a href="<?php //echo base_url(); ?>index.php/AdminController/Projects_add"><i class="fa fa-plus"></i>Add Projects</a></li>
                           ...
                           <!-- <form name="myform" id="myform" action="<?php //echo base_url();?>index.php/AdminController/deleteMultipleProjects/" method="post">
                                ...
                                <table id="example" class="table table-striped table-bordered example" width=100%>
                                	<thead>
                                    	<tr>
                                        	<th>Page Name</th>
                                            <th>Page Title</th>
                                            <th>Page Banner Images</th> 
                                            <th></th>
                                        </tr>
                                	</thead>  
                                    <tbody>
                                        <?php 
                                        if(count($sub_banners>0)){
                                        foreach ($sub_banners as $row) { ?>
                                    	<tr>
                                        	
                                        	<td><?php echo $row->page; ?></td>
                                           <td><?php echo $row->title; ?></td>
                                            <td><img src="<?php echo base_url();?>assets/images/uploads/sub_banner/<?php echo $row->image;  ?>" height="70"/></td>
                                           
                                           
                                            
                                            <td>
                                           
                                            	<a href="<?php echo base_url(); ?>index.php/AdminController/sub_banners_edit/<?php echo $row->id;?>"><button type="button" class="btn btn-success">Edit</button></a>
