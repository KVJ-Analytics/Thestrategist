	...
	<div class="wrapper">
  		...
  		<div class="content-wrapper">
  			<section class="col-lg-12">
               ...
               <form class="cmxform form-horizontal adminex-form" id="commentForm" method="post" action="<?php echo base_url(); ?>index.php/AdminController/add_Service_process" name="myform" enctype="multipart/form-data">
                        	...
                        	<div class="form-wrap">
                                ...
                                <table>
										...
										<tr>
                                            ...
                                            <td width="5%">:</td>
                                            <td width="80%"><input type="file" id="input-file-now-custom-2" class="dropify" data-height="150" name="userfileImageicon"  required/></td>
                                        </tr>
										<tr>
