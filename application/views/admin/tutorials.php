  		...
  		<div class="content-wrapper">
  			<section class="col-lg-12">
    			<div class="content-area">
                	...
                	<div class="col-md-12">
                    	<h2><i class="fa fa-file-text-o"></i> Tutorials</h2>
                    </div>
                	...
                	<div class="col-md-12">
                    	...
                    	<div class="form-wrap">
                           <div class="form-wrap-title list-form-wrap-title">
                                <h3 class="inline-block">Tutorials</h3>
                                <ul class="list-actions">
                                	<li class="created"><a href="<?php echo base_url(); ?>index.php/AdminController/tutorials_add"><i class="fa fa-plus"></i>Add</a></li>
                            ...
                            <form name="myform" id="myform" action="<?php echo base_url();?>index.php/AdminController/deleteMultipletutorial/" method="post">
                                    ...
                                    <tbody>
                                    	...
                                    	<tr>
                                            ...
                                            <td>
                                            	...
                                            	<a href="<?php echo base_url(); ?>index.php/AdminController/tutorial_edit/<?php echo $row->id;?>"><button type="button" class="btn btn-success">Edit</button></a>
                                            	<a href="<?php echo base_url(); ?>index.php/AdminController/tutorial_delete/<?php echo $row->id;?>"><button type="button" class="btn btn-danger">Delete</button></a>
												<!--<a href="<?php echo base_url(); ?>index.php/AdminController/tutorial_videos/<?php echo $row->id;?>"><button type="button" class="btn btn-success">Add/Remove More Videos</button></a>-->
                                          	</td>
                                        </tr> 
                                        <?php } 
                                    }
