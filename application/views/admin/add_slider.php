  		...
  		<div class="content-wrapper">
  			<section class="col-lg-12">
    			<div class="content-area">
                	<div class="col-md-12">
                    	<h2><i class="fa fa-file-text-o"></i> Add Slider</h2>
                    </div>                   
                    <div class="clearfix"></div>
                </div>
                <div class="content-area">
                    
               <form class="cmxform form-horizontal adminex-form" id="commentForm" method="post" action="<?php echo base_url(); ?>index.php/AdminController/add_Slider_process" name="myform" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-12">
                        	...
                        	<div class="form-wrap">
                                ...
                                <table>
										...
										<tr>
                                        	<td width="15%">Image (1920px X 671px)</td>
                                            <td width="5%">:</td>
                                         ...
                                         <tr>
                                        	<td>Description</td>
                                            <td>:</td>
                                            <td><input type="text" name="desc" value="" required/>
