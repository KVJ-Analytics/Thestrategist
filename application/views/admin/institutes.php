  		...
  		<div class="content-wrapper">
  			<section class="col-lg-12">
    			<div class="content-area">
                	...
                	<div class="col-md-12">
                    	<h2><i class="fa fa-file-text-o"></i>Institutes</h2>
                    </div>
                	...
                	<div class="col-md-12">
                    	...
                    	<div class="form-wrap">
                           <div class="form-wrap-title list-form-wrap-title">
                                <h3 class="inline-block">Institutes</h3>

                                <ul class="list-actions">
                                	<li class="created"><a href="<?php echo base_url(); ?>index.php/AdminController/institutes_add"><i class="fa fa-plus"></i>Add New</a></li>
                            ...
                            <form name="myform" id="myform" action="<?php echo base_url();?>index.php/AdminController/deleteMultipleinstitutes/" method="post">
                                ...
                                <table id="example" class="table table-striped table-bordered example" width=100%>
                                    ...
                                    <tbody>
                                    	...
                                    	<tr>
                                            ...
                                            <td><img style="width:100px;" src="<?php echo base_url();?>assets/images/uploads/institutes/<?php echo $row->image;  ?>"/></td>
                                           
                                           
                                            <td><?php echo $row->sort_order; ?></td>
                                            <td>
                                           
                                            	<a href="<?php echo base_url(); ?>index.php/AdminController/institutes_edit/<?php echo $row->id;?>"><button type="button" class="btn btn-success">Edit</button></a>
                                            	<a href="<?php echo base_url(); ?>index.php/AdminController/institutes_delete/<?php echo $row->id;?>"><button type="button" class="btn btn-danger">Delete</button></a>
                                          	</td>
                                        </tr> 
                                        <?php } 
                                    }
