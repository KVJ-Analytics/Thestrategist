  		...
  		<div class="content-wrapper">
  			<section class="col-lg-12">
                ...
                <div class="content-area">
                    ...
                    ?>
               <form class="cmxform form-horizontal adminex-form" id="commentForm" method="post" action="<?php echo base_url(); ?>index.php/AdminController/update_contact" name="myform" enctype="multipart/form-data">
                                ...
                                <table>
                                        ...
                                        <tr>
											...
											<input type="hidden" id="s_id" name="s_id" value="<?php echo $pid; ?>" required/>
                                                <input type="text" id="name" name="p_head1" value="<?php echo $email; ?>" required/></td>
                                        </tr>
										<tr>
                                            <td> Phone</td>
                                            <td>:</td>
                                            <td>
                                                ...
                                                <input type="text" id="name" name="p_head2" value="<?php echo $phone; ?>" required/></td>
                                        </tr>
                                        <tr>
                                            <td> Address</td>
                                            <td>:</td>
                                            <td><!--<input type="text" name="p_head2" value="<?php echo $ph2; ?>" required/>-->
											<textarea id="" name="desc"><?php echo $address; ?></textarea></td>
                                        </tr>
