  		...
  		<div class="content-wrapper">
			<section class="col-lg-12">
    			<div class="content-area">
                	<div class="col-md-12">
                    	<h2><i class="fa fa-file-text-o"></i>Add Product</h2>
                    </div>                   
                    <div class="clearfix"></div>
                </div>
                
                <div class="content-area">
               	<form class="cmxform form-horizontal adminex-form" id="commentForm" method="post" action="add_product_action.php" name="myform" enctype="multipart/form-data">
               		<input type="hidden" name="userid" id="userid" value="<?php echo $_SESSION['user_id'];?>"/>
                	<div class="col-md-12">                        
                        <div class="col-sm-12" style="padding-top:15px;">
                        	<?php if(isset($_REQUEST['flag'])){?>
                                <h5 style="color:#348B57; margin-bottom:20px;">Product Created Successfully!!!</h5>
                            <?php } ?>
                        	<div class="form-wrap">
                                ...
                                <div class="form-wrap-body form-tbl">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td><input type="checkbox" value="1" name="featured" /></td>
                                        </tr>
                                        <tr>
                                            <td>Sort Order</td>
                                            <td>:</td>
