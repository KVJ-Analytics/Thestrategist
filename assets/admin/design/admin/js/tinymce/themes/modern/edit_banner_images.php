  		...
  		<div class="content-wrapper">
  			<section class="col-lg-12">
                ...
                <?php 
					...
					$stmts5_banner =$mysqli->prepare("select title,image,caption,page_link,sort_order from banner where banner_id=?");	
					...
					$stmts5_banner->bind_result($title,$image,$caption,$page_link,$sort_order);
		
					$stmts5_banner->fetch();

		      ?>
                <div class="content-area">
               <form class="cmxform form-horizontal adminex-form" id="commentForm" method="post" action="edit_banner_action.php" name="myform" enctype="multipart/form-data">
               ...
               <input type="hidden" name="userid" id="userid" value="<?php echo $_SESSION['user_id'];?>"/>
                	...
                	<div class="col-md-12">                        
                        	...
                        	<div class="form-wrap">
                                ...
                                <table>
                                        ...
                                        <tr>
                                        	<td>Caption</td>
                                            <td>:</td>
                                            <td><textarea id="mytextarea"  name="des1" ><?php echo $caption; ?></textarea></td>
                                        </tr>
                                        <tr>
                                        	<td>Page Link</td>
                                            <td>:</td>
                                            <td><input type="text" id="page_link" name="page_link" value="<?php echo $page_link; ?>" /></td>
                                        </tr>
                                        <tr>
                                        	<td>Sort Order</td>
                                            <td>:</td>
                        ...
                        <div class="col-md-12 submit-form">
                        	<ul>
                            	<li><input type="submit" name="submit" value="Update Banner" /></li>
