  		...
  		<div class="content-wrapper">
  			<section class="col-lg-12">
    			<div class="content-area">
                	<div class="col-md-12">
                    	<h2><i class="fa fa-file-text-o"></i> Add Event</h2>
                    </div>                   
                    <div class="clearfix"></div>
                </div>
                <div class="content-area">
               <form class="cmxform form-horizontal adminex-form" id="commentForm" method="post" action="add_event_action.php" name="myform" enctype="multipart/form-data">
                        	...
                        	<div class="form-wrap">
                                ...
                                <table>
                                    	...
                                    	<tr>
                                        	<td>Date</td>
                                            <td>:</td>
                                            <td><input type="text" id="datepick" name="datepick" value="" required/></td>
                                        </tr>
                                        <tr>
                                        	<td>Type</td>
                                            <td>:</td>
